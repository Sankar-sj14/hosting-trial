...
const Hero = () => {
  return (
    <div className='bg-gradient-to-b  from-slate-500 via-gray-800 to-slate-800 p-4 h-auto flex flex-col sm:flex-row'>
        ...
        <h1><span className='text-4xl text-transparent bg-clip-text bg-gradient-to-r from-sky-200 via-white to-sky-200 font-extrabold flex justify-center p-4'>Advanced Business Solutions</span></h1>
